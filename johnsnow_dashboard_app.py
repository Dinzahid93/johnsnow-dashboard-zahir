...
with tab1:
    ...
    **Red areas show high concentrations**, revealing outbreak hotspots.
    """)
    ...
    for _, row in deaths.iterrows():
        ...
        folium.Marker(
            ...
            icon=folium.Icon(color="red", icon="fa-skull-crossbones", prefix="fa"),
            popup=popup
        ).add_to(fg_deaths)
...
with tab2:
    ...
    helping reveal which pumps contributed most to cholera spread.
    """)
