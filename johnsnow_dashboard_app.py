...
with tab1:
    ...
    st.markdown("This heatmap visualizes the **intensity of cholera fatalities** across the Soho district. Warmer colors (yellow–red) highlight concentrated clusters of deaths, revealing key outbreak hotspots that shaped John Snow’s landmark findings.")
...
with tab2:
    ...
    st.markdown("This analysis illustrates the **closest water pump for every recorded cholera death**. The connecting lines form a “spider web” pattern, revealing how contaminated water sources shaped the outbreak’s progression.")
...
with tab3:
    ...
    st.markdown("""
    This 3D visualization displays **vertically extruded bars**, with each bar’s height representing the number of cholera deaths recorded at that location.  
    This perspective highlights buildings with the highest mortality and reveals spatial patterns that were essential to John Snow’s analysis.
    """)
